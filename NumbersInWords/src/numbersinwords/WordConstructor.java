...
public class WordConstructor {
	...
	private String digitName(String digit) {
	...
	private String tupleName(String number) {
	...
	private String tripleName(String number) {
	...
	private String stripZeroes(String input) {
	...
	public String constructWord(String number) {
